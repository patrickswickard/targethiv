...
for file in os.listdir("/home/swickape/projects/github/targethiv/bytype/best_practices"):
  if file.endswith(".html"):
    filelist.append(os.path.join("/home/swickape/projects/github/targethiv/bytype/best_practices", file))
