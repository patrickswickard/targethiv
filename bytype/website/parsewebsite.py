...
for file in os.listdir("/home/swickape/projects/github/targethiv/bytype/website"):
  if file.endswith(".html"):
    filelist.append(os.path.join("/home/swickape/projects/github/targethiv/bytype/website", file))
#print(filelist)
