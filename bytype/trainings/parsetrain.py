...
for file in os.listdir("/home/swickape/projects/github/targethiv/bytype/trainings"):
  if file.endswith(".html"):
    filelist.append(os.path.join("/home/swickape/projects/github/targethiv/bytype/trainings", file))
#print(filelist)
