...
for file in os.listdir("/home/swickape/projects/github/targethiv/bytype/replication_resources"):
  if file.endswith(".html"):
    filelist.append(os.path.join("/home/swickape/projects/github/targethiv/bytype/replication_resources", file))
#print(filelist)
